...
!function (e, t) {
  ...
  return function (e) {
      ...
      var t = function (e) {
        ...
        return s(t, e), i(t, {
          getOptions: {
            ...
            value: function () {
              var e = this.uploader.isHTML5 ? this.element[0].files : this.element[0], t = this.getOptions(),
                n = this.getFilters();
    ...
    var r = function (e) {
        ...
        if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
      }, s = (r(n(2)), angular.copy), a = angular.extend, u = angular.forEach, l = angular.isObject, c = angular.isNumber,
      f = angular.isDefined, p = angular.isArray, d = angular.element;
        ...
        return i(r, {
          addToQueue: {
            value: function (e, t, n) {
              var r = this, i = this.isArrayLikeObject(e) ? e : [e], o = this._getFilters(n), s = this.queue.length,
                a = [];
              u(i, function (e) {
                var n = new v(e);
            ...
            value: function (e) {
              ...
              var t = this.getNotUploadedItems().length, n = t ? this.queue.length - t : this.queue.length,
                r = 100 / this.queue.length, i = (e || 0) * r / 100;
            ...
            value: function (e) {
              ...
              r.append(e.alias, e._file, encodeURIComponent(e.file.name)), n.upload.onprogress = function (n) {
